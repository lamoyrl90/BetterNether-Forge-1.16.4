...
import redd90.betternether.blocks.RubeusLog;
...
public class StructureRubeus extends StructureFuncScatter {
	...
	private void setIfAir(IWorld world, BlockPos pos, BlockState state) {
		...
		if (world.isAirBlock(pos) || bState.getMaterial().isReplaceable() || bState.getBlock() == BlocksRegistry.RUBEUS_LEAVES || bState.getBlock() == BlocksRegistry.RUBEUS_CONE)
