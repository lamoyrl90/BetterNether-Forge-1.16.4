...
import redd90.betternether.blocks.*;
import redd90.betternether.blocks.complex.ColoredGlassMaterial;
import redd90.betternether.blocks.complex.WoodenMaterial;
import redd90.betternether.config.Configs;
import redd90.betternether.datagen.BNRecipes;
...
public class BlocksRegistry {
	...
	public static final Block SOUL_SANDSTONE_SMOOTH = registerMakeable2X2("soul_sandstone_smooth", new BlockBase(AbstractBlock.Properties.from(Blocks.SANDSTONE)), "soul_sandstone", SOUL_SANDSTONE_CUT);
	public static final Block SOUL_SANDSTONE_CHISELED = registerMakeable2X2("soul_sandstone_chiseled", new BlockBase(AbstractBlock.Properties.from(Blocks.SANDSTONE)), "soul_sandstone", SOUL_SANDSTONE_SMOOTH);
	...
	// Basalt Bricks //
	public static final Block BASALT_BRICKS = registerMakeable2X2("basalt_bricks", new BlockBase(AbstractBlock.Properties.from(Blocks.BASALT)), "basalt_bricks", Blocks.POLISHED_BASALT);
	...
	public static void registerAll(RegistryEvent.Register<Block> e) {
	...
	private static void addFuel(Block source, Block result) {
		if (source.getDefaultState().getMaterial().isFlammable()) {
			FuelRegistry.addFuel(result, 40);
		}
	}
	...
	public static Block registerStairs(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.STAIRS.add(new BNRecipes.SingleInputRecipe(source, stairs));
		}
		return stairs;
	}
	...
	public static Block registerSlab(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			addFuel(source, slab);
			BNRecipes.SLABS.add(new BNRecipes.SingleInputRecipe(source, slab));
		}
		return slab;
	}
	...
	private static Block registerRoof(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			addFuel(source, roof);
			BNRecipes.ROOFS.add(new BNRecipes.SingleInputRecipe(source, roof));
		}
		return roof;
	}
	...
	public static Block registerButton(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.SHAPELESS.add(new BNRecipes.SingleInputRecipe(source, button, 1));
		}
		return button;
	}
	...
	public static Block registerPlate(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.PLATES.add(new BNRecipes.SingleInputRecipe(source, plate));
		}
		return plate;
	}
	...
	public static Block registerPlanks(String name, Block planks, Block... logs) {
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			for (Block log : logs)
				BNRecipes.SHAPELESS.add(new BNRecipes.SingleInputRecipe(log, planks, 4));
		}
		return planks;
	}
	...
	private static Block registerPlanks(String name, Block planks, int output, Block stem, Block... logs) {
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, planks);
			BNRecipes.SHAPELESS.add(new BNRecipes.SingleInputRecipe(stem, planks, output));
			for (Block log : logs)
				BNRecipes.SHAPELESS.add(new BNRecipes.SingleInputRecipe(log, planks, 4));
		}
		return planks;
	...
	public static Block registerLog(String name, Block log, Block stem) {
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.TWOBYTWO.add(new BNRecipes.SingleInputRecipe(stem, log, 1));
		}
		return log;
	}
	...
	public static Block registerBark(String name, Block bark, Block log) {
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.TWOBYTWO.add(new BNRecipes.SingleInputRecipe(log, bark, 3));
		}
		return bark;
	}
	...
	public static Block registerFence(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.FENCES.add(new BNRecipes.SingleInputRecipe(source, fence));
		}
		return fence;
	}
	...
	public static Block registerGate(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			addFuel(source, gate);
			BNRecipes.GATES.add(new BNRecipes.SingleInputRecipe(source, gate));
		}
		return gate;
	}
	...
	public static Block registerDoor(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			addFuel(source, door);
			BNRecipes.DOORS.add(new BNRecipes.SingleInputRecipe(source, door));
		}
		return door;
	}
	...
	public static Block registerTrapdoor(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.TRAPDOORS.add(new BNRecipes.SingleInputRecipe(source, trapdoor));
		}
		return trapdoor;
	}
	...
	public static Block registerMakeable2X2(String name, Block result, String group, Block... sources) {
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			for (Block source : sources)
				BNRecipes.TWOBYTWO.add(new BNRecipes.SingleInputRecipe(source, result, 4));
		}
		return result;
	}
	...
	public static Block registerWall(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.WALLS.add(new BNRecipes.SingleInputRecipe(source, wall));
		}
		return wall;
	}
	...
	public static Block registerCraftingTable(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			BNRecipes.TWOBYTWO.add(new BNRecipes.SingleInputRecipe(source, block, 1));
		}
		return block;
	}
	...
	public static Block registerChest(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			...
			BNRecipes.ROUND.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	public static Block registerSign(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.SIGNS.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	public static Block registerBarrel(String name, Block source, Block slab) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.BARRELS.add(new BNRecipes.TwoInputRecipe(source, slab, block));
		}
		return block;
	}
	...
	public static Block registerLadder(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.LADDERS.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	public static Block registerTaburet(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.TABURETS.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	public static Block registerChair(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.CHAIRS.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	public static Block registerBarStool(String name, Block source) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			addFuel(source, block);
			BNRecipes.BAR_STOOLS.add(new BNRecipes.SingleInputRecipe(source, block));
		}
		return block;
	}
	...
	private static Block registerFireBowl(String name, Block source, Block inside, Item leg) {
		...
		if (Configs.BLOCKS.getBoolean("blocks", name, true)) {
			registerBlockDirectly(name, block);
			BNRecipes.FIRE_BOWLS.add(new BNRecipes.FireBowlRecipe(source, inside, leg, block));
		}
		return block;
	}
