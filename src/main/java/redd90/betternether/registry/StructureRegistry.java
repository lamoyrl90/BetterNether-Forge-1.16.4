...
import redd90.betternether.structures.plants.*;
import redd90.betternether.world.structures.CityFeature;
import redd90.betternether.structures.decorations.*;
...
public class StructureRegistry {
	...
	public static final Structure<NoFeatureConfig> CITY = registerStructure("nether_city", new CityFeature(), GenerationStage.Decoration.RAW_GENERATION, new StructureSeparationSettings(cityDistance, citySeparation, 1234));
